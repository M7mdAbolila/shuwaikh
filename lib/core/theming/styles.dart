...
class TextStyles {
  ...
  static TextStyle font30White400Weight = TextStyle(
    fontSize: 30.sp,
    fontWeight: FontWeight.w400,
    color: Colors.white,
  );
  static TextStyle font26White500Weight = TextStyle(
    fontSize: 26.sp,
    fontWeight: FontWeight.w500,
    color: Colors.white,
  );
  static TextStyle font20White700Weight = TextStyle(
    fontSize: 20.sp,
    fontWeight: FontWeight.w700,
    color: Colors.white,
  );
  static TextStyle font13White500Weight = TextStyle(
    fontSize: 13.sp,
    fontWeight: FontWeight.w500,
    color: Colors.white,
  );
  ...
  static TextStyle font24Black500Weight = TextStyle(
    fontSize: 24.sp,
    fontWeight: FontWeight.w500,
    color: Colors.black,
  );

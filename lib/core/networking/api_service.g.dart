...
class _ApiService implements ApiService {
  ...
  Future<ShippingChargeResponse> shippingCharge(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ShippingChargeResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ShippingChargeResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<MyOrdersResponse> getMyOrder(String? token) async {
    ...
    final value = MyOrdersResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<DeleteAccountReponse> unactiveAccount(String? token) async {
    ...
    final value = DeleteAccountReponse.fromJson(_result.data!);
    return value;
  }
